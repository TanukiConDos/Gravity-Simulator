	    ...
	    */
		...
		public:
			...
			*/
			...
			/**
			* @brief Envía el contenido del buffer a la GPU.
			*
			* Este método actualiza el buffer de la GPU con los datos actualmente mapeados en la memoria.
			*/
			void sendToGPU();
		private:
			...
			/// Estructura que define la región de memoria mapeada para operaciones de sincronización y actualizaciones.
			VkMappedMemoryRange _memoryRange;
		};
	}
}
